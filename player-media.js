function createMediaController(options){
    ...
    function updatePitchStatus(){
        ...
        elements.pitchValue.title =
            ...
            : "Tonalità fallback: cambia anche la velocità";
    ...
    function applyPlaybackRate(){
        ...
        const pitchRatio =
            !rubberBandReady && currentPitchShift !== 0
            ? Math.pow(2, currentPitchShift / 12)
            : 1;

        const effectiveRate =
            currentPlaybackRate * pitchRatio;
    ...
    async function ensureRubberBandEngine(){
        ...
        if(!RubberBandEngine){
            console.log("Rubber Band non caricato");
            return null;
        }
